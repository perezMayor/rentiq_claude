...
export default function ContratoDirectoForm({ clients, categories, branches, onClose, onSaved }: Props) {
  ...
  function recalcTotal() {
    ...
    const ext   = parseFloat(form.extrasTotal)    || 0;
    ...
    setForm((prev) => ({ ...prev, total: (base + ext + ins + fuel + pen - disc).toFixed(2) }));
  }
    ...
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        <div className="modal__header">
          <h2 className="modal__title">Nuevo contrato directo</h2>
          ...
          <div className="modal__body">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <input type="text" className="form-input" value={form.pickupLocation} onChange={(e) => set('pickupLocation', e.target.value)} placeholder="Dirección o punto de entrega" />
              </div>

              {/* Lugar de recogida */}
              <div className="form-group">
                <label className="form-label">Lugar de recogida</label>
                <input type="text" className="form-input" value={form.returnLocation} onChange={(e) => set('returnLocation', e.target.value)} placeholder="Dirección o punto de recogida" />
              </div>
              ...
              <div className="form-group">
                ...
                <input type="number" className="form-input" value={form.billedDays} onChange={(e) => set('billedDays', e.target.value)} min="1" required />
              </div>

              {/* Base */}
              <div className="form-group">
                <label className="form-label">Precio base (€)</label>
                <input type="number" className="form-input" value={form.basePrice} onChange={(e) => set('basePrice', e.target.value)} min="0" step="0.01" onBlur={recalcTotal} />
              </div>

              {/* Extras */}
              <div className="form-group">
                <label className="form-label">Extras (€)</label>
                <input type="number" className="form-input" value={form.extrasTotal} onChange={(e) => set('extrasTotal', e.target.value)} min="0" step="0.01" onBlur={recalcTotal} />
              </div>

              {/* Seguro */}
              <div className="form-group">
                <label className="form-label">Seguro (€)</label>
                <input type="number" className="form-input" value={form.insuranceTotal} onChange={(e) => set('insuranceTotal', e.target.value)} min="0" step="0.01" onBlur={recalcTotal} />
              </div>

              {/* Combustible */}
              <div className="form-group">
                <label className="form-label">Combustible (€)</label>
                <input type="number" className="form-input" value={form.fuelCharge} onChange={(e) => set('fuelCharge', e.target.value)} min="0" step="0.01" onBlur={recalcTotal} />
              </div>

              {/* Penalizaciones */}
              <div className="form-group">
                <label className="form-label">Penalizaciones (€)</label>
                <input type="number" className="form-input" value={form.penalties} onChange={(e) => set('penalties', e.target.value)} min="0" step="0.01" onBlur={recalcTotal} />
              </div>

              {/* Descuento */}
              <div className="form-group">
                <label className="form-label">Descuento (€)</label>
                <input type="number" className="form-input" value={form.discount} onChange={(e) => set('discount', e.target.value)} min="0" step="0.01" onBlur={recalcTotal} />
              </div>

              {/* Total */}
              <div className="form-group">
                <label className="form-label">Total (€)</label>
                <input type="number" className="form-input" value={form.total} onChange={(e) => set('total', e.target.value)} min="0" step="0.01" style={{ fontWeight: 600 }} />
              </div>

              {/* Notas */}
              <div className="form-group col-span-2">
                <label className="form-label">Notas</label>
                <textarea className="form-textarea" value={form.notes} onChange={(e) => set('notes', e.target.value)} placeholder="Observaciones internas…" />
              </div>
