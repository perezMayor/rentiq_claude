...
import ExtrasTabContent, { type FormExtra, type NightFeeConfig } from '../reservas/ExtrasTabContent';
...
export default function GestionContratoTab() {
  ...
  function recalcTotal(updated?: Partial<FormState>) {
    ...
    setForm((prev) => ({ ...prev, ...updated, total: (base - disc + ins + ext + fuel + extn + night).toFixed(2) }));
  }
        ...
        <div className={styles.card}>
          ...
          <div className={styles.liquidacion}>
            ...
            <div className={styles.liqRow}>
              ...
              <input className={styles.liqInput} type="number" min={0} step="0.01" value={form.basePrice} onChange={(e) => set('basePrice', e.target.value)} onBlur={() => handleNumBlur('basePrice')} />
            </div>
